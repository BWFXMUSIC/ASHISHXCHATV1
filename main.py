...
SOURCE = 'https://t.me/MUSICBOT_OWNER'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
async def restart(client, m: Message):
        ...
        await accha.edit("🦋ʙω͠ғ ᴄʜᴀᴛʙᴏᴛ💨 ѕтαятιиg❣️ @MUSICBOT_OWNER ")
        await asyncio.sleep(0.5)
        await accha.edit("https://graph.org/file/d526c3c791abd4cde51b6.jpg")
        await asyncio.sleep(0.5)
        await accha.delete()
